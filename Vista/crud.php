...
$sql = "SELECT id, title, price, available_quantity, category_id, image_url FROM products";
...
<header>
  ...
  <br><br><br>
    <div class="container">
        <a href="processcrud/crear.php" class="btn btn-primary mb-3">Nuevo Producto</a>
        <table class="table">
            <thead>
                <tr>
                    <th>ID</th>
            ...
            <tbody>
                <?php foreach ($productos as $producto): ?>
                    <tr>
                        ...
                        <td>
                            <a href="processcrud/editar.php?id=<?php echo $producto["id"]; ?>" class="btn btn-primary btn-sm">Editar</a>
                            <a href="processcrud/eliminar.php?id=<?php echo $producto["id"]; ?>" class="btn btn-danger btn-sm">Eliminar</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
